...
{	
	...
	{	EntityManager em = null;
		...
		{	// transiente - objeto novo: ainda não persistente
			...
			em.persist(umProduto); //faz uma inserção
			tx.commit(); //commita as alterações
		...
		{	
			...
			{	
				try
				{	
					tx.rollback(); //retorna ao estado anterior, caso a transação esteja aberta
				}
