...
public interface ContaDAO {
    ...
    void debita(Conta umaConta, double valor) throws ObjetoNaoEncontradoException;

    void credita(Conta umaConta, double valor) throws ObjetoNaoEncontradoException;
